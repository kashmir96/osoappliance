...
errorCodeForm.addEventListener("submit", function(e) {
  ...
  errorCodes.forEach(function(errorCode) {
    ...
    const description = errorCode.querySelector("p").textContent;

    if (heading.toLowerCase().includes(searchTerm) || brand.toLowerCase().includes(searchTerm) || description.toLowerCase().includes(searchTerm)) {
