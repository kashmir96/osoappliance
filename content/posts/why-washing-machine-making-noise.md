...
cover: 
 image: /img/washingmachine/326.webp
 alt: 'someones subtle washing machine used completely'

---

Washing machines making noise is a common issue that can be caused by a variety of factors. The most common cause of noise is an unbalanced load of laundry, which can cause a thumping noise as the machine tries to balance out the load. This can be fixed by redistributing the load to ensure that it is evenly balanced. Another common cause of noise is a malfunctioning motor or belt, which can cause a loud banging or clicking noise. If this is the case, the motor or belt will need to be replaced.
