...
title: Why Dryer Not Spinning
description: "If your dryer isn’t spinning, it can be a real hassle. There are several potential causes of this issue, but thankfully, some of t...get the full scoop"
keywords: dryer
...
Check the Dryer Lint Trap 
The lint trap built into your dryer catches debris from clothes as they dry. This debris can clog up the airflow in your dryer and stop it from spinning properly. Check the lint trap for any blockages or large clumps of lint that could be preventing proper air circulation, and remove them if you find any.

Check Your Power Source 
If your dryer isn’t getting power, then it won’t spin—it’s as simple as that! Check that the power is connected properly to both your outlet and the machine itself. If everything seems connected correctly then you may need to call an electrician to troubleshoot further.
